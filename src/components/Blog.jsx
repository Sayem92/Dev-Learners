        ...
        <div className='m-3 md:m-6'>
            <div className="w-full p-6 mb-4 overflow-hidden rounded-lg shadow bg-gray-900 text-gray-100 ">
                <article className='mb-6'>
                    <h2 className="text-xl font-bold">Q-1: What is the purpose of React Router ?</h2>
            ...
            <div className="w-full p-6 mb-4 overflow-hidden rounded-lg shadow bg-gray-900 text-gray-100 ">
                ...
                <article className='mb-6'>
                    <h2 className="text-xl font-bold">Q-2: How does context API works ?</h2>
            ...
            <div className="w-full p-6 mb-4 overflow-hidden rounded-lg shadow bg-gray-900 text-gray-100 ">
                ...
                <article className='mb-6'>
                    <h2 className="text-xl font-bold">Q-3: What is the useRef hook ?</h2>
